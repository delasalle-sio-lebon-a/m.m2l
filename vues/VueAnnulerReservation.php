...
// fichier : controleurs/VueAnnulerReservation.php
// Rôle : Afficher l'annulation d'une réservation
			...
			<div data-role="content">
				...
				<form action="index.php?action=AnnulerReservation" method="post" data-ajax="false">
					...
					<div data-role="fieldcontain">
						<input type="submit" name="btnAnnulerRes" id="btnAnnulerRes" value="Annuler la réservation" data-mini="true">
					</div>
				</form>
