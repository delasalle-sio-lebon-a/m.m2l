        ...
        if ($name == '') {
            ...
            if ( ! $dao->existeUtilisateur($name) ) {
                ...
                if ( ! $ok ) {
                    ...
                    $contenuMail = "L'administrateur du système de réservations de la M2L vient de supprimer un compte utilisateur.\n\n";                   
                    $ok = Outils::envoyerMail($adrMail, $sujet, $contenuMail, $ADR_MAIL_EMETTEUR);
                    if ( ! $ok ) {
                        // si l'envoi de mail a échoué, réaffichage de la vue avec un message explicatif
                        $message = "Suppression non-effectué.<br>L'envoi du mail à l'utilisateur a rencontré un problème !";
                        $typeMessage = 'avertissement';
                        $themeFooter = $themeProbleme;
                        include_once ('vues/VueSupprimerUtilisateur.php');
                    }
